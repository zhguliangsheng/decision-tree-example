...
#绘制图像
list_avg=[]
list_avg.append(acc_avg)
list_avg=list_avg*20
plt.plot(list_num, list_acc,label='all',marker = "o",markersize=10)
plt.plot(list_num, list_avg,label='mean',marker = "x",markersize=8)
